...
export default function Accordions() {
  return (
    <div className="m-5">
      ...
      <p>Accordion with start alignment</p>
      <div className="m-4">
      ...
      <p>Accordion with flush alignment</p>
      <div className="m-4">
      ...
      <p>Accordion with sm size</p>
      <div className="m-4">
        <Accordion size="sm" type="multiple" className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>Is it accessible?</AccordionTrigger>
            <AccordionContent>
              Yes. It adheres to the WAI-ARIA design pattern.
      ...
      <p>Accordion with lg size</p>
      <div className="m-4">
        <Accordion size="lg" type="multiple" className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>Is it accessible?</AccordionTrigger>
            <AccordionContent>
              Yes. It adheres to the WAI-ARIA design pattern.
